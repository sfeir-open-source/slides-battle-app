...
import ListItems, {AddButton} from "./ListItems";
import Configuration from "./Configuration";
import { mount, shallow } from 'enzyme';
import { UlListItems } from './ListItems.jsx';
...
describe("<ListItems />", () => {
	...
	it("should <UlListItems /> have correct datas", () => {
		...
		const wrapper = shallow(<UlListItems items={store.getState().topics} onClickOutside={onClickOutsideMock} />);
	...
	it("should handleCheck have correct behavior", () => {
		...
		const checkboxe = container.querySelector("input[type='checkbox'][name='Histoire']");
		act(() => {
